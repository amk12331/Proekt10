...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('бургер.png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w1 = GameSprite('kora.jpg',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('kora.jpg', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('сундук.jpg', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('сундук.jpg', win_width - 85, win_height - 100, 80, 80)


monster1 = Enemy('MrKrabs.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('MrKrabs.png', win_width - 80, 230, 80, 80, 5)
